...
public class <FOO>SetTest{
  private ZHMutableMathSet<String>
    emptySetDefaultLength, emptySetNotDefaultLength,
    notEmptySet, notEmptySet2, notEmptySet3, notEmptySet4, result;
  
  @Before
  public void init(){
    emptySetDefaultLength = new <FOO>ArraySet<String>();
    emptySetNotDefaultLength = new <FOO>ArraySet<String>(3);
    result = new <FOO>ArraySet<String>();
    notEmptySet = new <FOO>ArraySet<String>();
    notEmptySet.add("A");
    notEmptySet.add("B");
    
    notEmptySet2 = new <FOO>ArraySet<String>();
    notEmptySet2.add("A");
    notEmptySet2.add("C");
    notEmptySet2.add("Y");
    notEmptySet2.add("Z");
    
    notEmptySet3 = new <FOO>ArraySet<String>();
    notEmptySet3.add("X");
    notEmptySet3.add("Y");
    notEmptySet3.add("Z");
    
    notEmptySet4 = new <FOO>ArraySet<String>();
    notEmptySet4.add("X");
    notEmptySet4.add("Y");
    notEmptySet4.add("A");
    notEmptySet4.add("Z");    
